...
ok(method_history_ok(
       [
        ...
        'PUT http://controller:35357/v3/projects/10/tags/regone \{\} ',
        'POST .*/regions/ .*"id":"regtwo',
        'PUT http://controller:35357/v3/projects/10/tags/regtwo \{\} ',
        'POST .*/regions/ .*"id":"a2nd".*parent_region_id":"regone"',
        'PUT http://controller:35357/v3/projects/10/tags/a2nd \{\} ',
        'PATCH http://controller:35357/v3/regions/toremove .*"enabled":false.* ',
        'DELETE http://controller:35357/v3/projects/10/tags/toremove ',
       ], [
        'POST .*/regions/ .*"parent"',
       ]),
