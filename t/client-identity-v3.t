...
ok(method_history_ok(
       [
        ...
        'PUT http://controller:35357/v3/projects/10/tag/regone \{\} ',
        'PUT http://controller:35357/v3/projects/10/tag/regtwo \{\} ',
        'PUT http://controller:35357/v3/projects/10/tag/a2nd \{\} ',
        'PATCH http://controller:35357/v3/regions/toremove .*"enabled":false.* ',
        'DELETE http://controller:35357/v3/projects/10/tag/toremove ',
       ], [
        'POST .*/regions/ .*"parent"',
       ]),
